...
(function () {
  ...
  T.en = {
    ...
    'Quatre configurations, une seule promesse : un simulateur fiable et complet. Tarif communiqué sur devis.': 'Four configurations, one promise: a reliable, complete simulator. Pricing on request.',
    ...
    "VitalX — L'essentiel": 'VitalX — The essentials',
    'VitalX PLUS — Formateur inclus': 'VitalX PLUS — Trainer included',
    'VitalX Pro — Génération V2': 'VitalX Pro — V2 generation',
    ...
    '👑 VitalX Ultra — Le plus complet': '👑 VitalX Ultra — The most complete',
    '1 iPad 11\" — moniteur': '1 × 11\" iPad — monitor',
    '2 iPad 11" — moniteur + formateur': '2 × 11" iPads — monitor + trainer',
    '2 iPad 11"': '2 × 11" iPads',
    '— formateur + élève': '— trainer + trainee',
    '1 iPad Air 13\" — grand format': '1 × 13\" iPad Air — large format',
    'iPad Air 13\" + iPad 11\" formateur': '13\" iPad Air + 11\" iPad trainer',
    '— moniteur + formateur': '— monitor + trainer',
    ...
    '+ 1 iPad 11"': '+ 1 × 11" iPad',
    'Personnalisez votre tenue avec nos écussons PVC 3D.': 'Add our 3D PVC patches to your uniform.',
  ...
  T.de = {
    ...
    'Quatre configurations, une seule promesse : un simulateur fiable et complet. Tarif communiqué sur devis.': 'Vier Konfigurationen, ein Versprechen: ein zuverlässiger, vollständiger Simulator. Preis auf Anfrage.',
    'Reconditionné': 'Refurbished',
    '1 iPad': '1 iPad',
    '2 iPad': '2 iPads',
    ...
    "VitalX — L'essentiel": 'VitalX — Das Wesentliche',
    'VitalX PLUS — Formateur inclus': 'VitalX PLUS — mit Trainergerät',
    'VitalX Pro — Génération V2': 'VitalX Pro — V2-Generation',
    ...
    '👑 VitalX Ultra — Le plus complet': '👑 VitalX Ultra — Das kompletteste',
    '1 iPad 11\" — moniteur': '1 × iPad 11\" — Monitor',
    '2 iPad 11\" — moniteur + formateur': '2 × iPad 11\" — Monitor + Trainer',
    'Best-seller': 'Bestseller',
    '2 iPad 11"': '2 × iPad 11"',
    '— formateur + élève': '— Trainer + Teilnehmer',
    '1 iPad Air 13\" — grand format': '1 × iPad Air 13\" — Großformat',
    'iPad Air 13\" + iPad 11\" formateur': 'iPad Air 13\" + iPad 11\" Trainer',
    '— moniteur + formateur': '— Monitor + Trainer',
    ...
    '+ 1 iPad 11"': '+ 1 × iPad 11"',
    'Personnalisez votre tenue avec nos écussons PVC 3D.': 'Personalisieren Sie Ihre Einsatzkleidung mit unseren 3D-PVC-Aufnähern.',
    'Écusson Chat Noir': 'Aufnäher Schwarze Katze',
    'Écusson VitalX 2K26': 'Aufnäher VitalX 2K26',
    'Écusson Stop Blood': 'Aufnäher Stop Blood',
    'PVC 3D souple · thermocollant': 'Weiches 3D-PVC · zum Aufbügeln',
    'TTC': 'inkl. MwSt.',
